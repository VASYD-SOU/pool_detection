...
from pool_module.iou import compute_iou
...
for (i, imagePath) in enumerate(imagePaths):
	...
	# use nms to remove boxes that overlap to much
	idxs = non_max_suppression(np.array(proposedRects, dtype="int32"), 0.6)
	proposedRects = [proposedRects[x] for x in idxs]
